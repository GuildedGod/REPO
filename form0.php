...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Casey Foundation | Juvenile Detention Alternatives Initiative Submission System</title>
...
<button class="btn disabled" onclick="location.href='form0.html'">Instructions</button>
  ...
  <button class="btn" onclick="location.href='form8.php'">Final Notes</button>
      ...
      <h3>Instructions</h3>
      <p>Here is the section where you would include instructions about how to use the tool.</p>
      <p>
      <input class="btn btn-large btn-success" id="new_report_button" type="button" value="Start a New Report" />
      <input class="btn btn-large btn-primary" id="new_report_button" type="button" value="Continue Your Existing Report" onclick="location.href='form1.html'" />
      </p>
      <!--
      <p><button class="btn btn-large btn-primary btn-success"  onclick="location.href='form1.html'" type="button">Start Here</button></p>
      -->
