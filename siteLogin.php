...
<html lang="en">
  ...
  <!-- JavaScript Code -->
    ...
    <script type="application/javascript" src="js/casey_include_siteLogin.js"></script>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin">
        ...
        <div id="show_user_drop_down_list"></div>
        ...
        <input class="btn btn-large btn-primary" type="button" id="site_login_page_button" value="Sign in" />
