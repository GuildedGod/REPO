...
function mediaTypeForm()
{
  ...
  <input type="radio" name="media_type" id="select_newspaper" value="Newspaper" checked>
  Newspaper 
</label>
<label class="radio inline">
  <input type="radio" name="media_type" id="select_magazine" value="Magazine">
  Magazine 
</label>
<label class="radio inline">
  <input type="radio" name="media_type" id="select_website" value="Website">
 Website 
</label>
<label class="radio inline">
  <input type="radio" name="media_type" id="select_tv" value="TV">
 TV 
</label>
<label class="radio inline">
  <input type="radio" name="media_type" id="select_other" value="Other">
  Other
</label><br>
Name of Media: <input class="span8" type="text" id="media_name" placeholder="Also include brief description">';
} // End of function
