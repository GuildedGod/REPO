...
$.post('php/get_all_leverage.php', function(data) {
		...
		$.each(pushedData, function(i, serverData) { 
			...
			if (serverData.current_year == current_year) 
			{
				...
				totalCurrentAmount = totalCurrentAmount + parseInt(allLeverageAmounts2[i]);
		...
		/*============== Canvas JS Demo ============== */
			var chart = new CanvasJS.Chart("chartContainerCurrentLeverage",
			{
				theme: "theme1",
				data: [
				{       
					...
					dataPoints: [
						{  y: currentYearLocalGovernment, legendText:"Local Government", indexLabel: "Local Government" },
						{  y: currentYearStateFederal, legendText:"State/Federal", indexLabel: "State/Federal" },
						{  y: currentYearFoundation, legendText:"Foundation/Private", indexLabel: "Foundation/Private" },
						{  y: currentYearMatch, legendText:"In-Kind Match", indexLabel: "In-Kind Match" },
						{  y: currentYearOther, legendText:"Other" , indexLabel: "Other"}
					]
				}
				]
			});
			...
			var chart2 = new CanvasJS.Chart("chartContainerCurrentLeverageAmount",
			{
				theme: "theme1",
				title:{
				...
				{       
					...
					yValueFormatString: "##,,. Items",
					dataPoints: [
						{  y: currentYearLocalGovernmentAmount, legendText:"Local Government", indexLabel: "Local Government" },
						{  y: currentYearStateFederalAmount, legendText:"State/Federal", indexLabel: "State/Federal" },
						{  y: currentYearFoundationAmount, legendText:"Foundation/Private", indexLabel: "Foundation/Private" },
						{  y: currentYearMatchAmount, legendText:"In-Kind Match", indexLabel: "In-Kind Match" },
						{  y: currentYearOtherAmount, legendText:"Other" , indexLabel: "Other"}
					]
				}
				]
			});
		...
		$('#totalCurrentAmount').html('$' + commaSeparateNumber(totalCurrentAmount));
