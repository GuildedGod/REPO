...
$.post('php/get_reports.php', function(data) {
		...
		$.each(pushedData, function(i, serverData) { 
			...
			if ((allReportYears[i] == selected_year) && (localStorage.getItem("team_leader_name") === "Administration" /*|| "Manager"*/)) {
			...
			currentYearReportsTable += '<td> <input class="btn btn-primary" type="button" id="view_this_report" value="View Report" onclick="alert(';
			// localStorage.current_report_ID = ' + serverData.report_ID + ';localStorage.jdai_site_name = "' + serverData.site_name + '";
...
$('#site_login_page_button').click(function() {
	...
	for (var i = 0; i < allUserSitesID.length; i++)
	  {	  
	   ...
	   localStorage.selected_year = selected_year;
